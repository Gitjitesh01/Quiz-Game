              ...
              <tr {...headerGroup.getHeaderGroupProps()} key={index}>
                {headerGroup.headers.map((column, index) => (
                  <th
                    ...
                    key={index}
                    className="dark:!border-navy-700 border-b border-gray-200 pb-[10px] pr-14 text-start"
                  >
                ...
                <tr {...row.getRowProps()} key={index}>
                  {row.cells.map((cell, index) => {
                    ...
                    if (cell.column.Header === "NAME") {
                      ...
                      data = (
                        <p className="text-navy-700 mr-[10px] text-sm font-semibold dark:text-white">
                          {cell.value}%
                        </p>
                      );
