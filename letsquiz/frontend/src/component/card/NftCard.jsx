      ...
      <div className="h-full w-full">
        ...
        <div className="3xl:flex-row 3xl:justify-between mb-3 flex items-center justify-between px-1 md:flex-col md:items-start lg:flex-row lg:justify-between xl:flex-col xl:items-start">
          ...
          <div className="flex flex-row-reverse md:mt-2 lg:mt-0">
            <span className="text-navy-700 dark:!border-navy-800 z-0 ml-px inline-flex h-8 w-8 items-center justify-center rounded-full border-2 border-white bg-[#E0E5F2] text-xs dark:bg-gray-800 dark:text-white">
              +5
            </span>
            {bidders.map((avt, key) => (
              <span
                key={key}
                className="dark:!border-navy-800 z-10 -mr-3 h-8 w-8 rounded-full border-2 border-white"
              >
                <img
        ...
        <div className="3xl:flex-row 3xl:items-center 3xl:justify-between flex items-center justify-between md:flex-col md:items-start lg:flex-row lg:justify-between xl:flex-col 2xl:items-start">
          ...
          <button
            href=""
            className="linear bg-brand-900 hover:bg-brand-800 active:bg-brand-700 dark:bg-brand-400 dark:hover:bg-brand-300 rounded-[20px] px-4 py-2 text-base font-medium text-white transition duration-200 dark:active:opacity-90"
          >
            Place Bid
          </button>
        </div>
