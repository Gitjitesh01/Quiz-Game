...
const PollManage = () => {
  ...
  const columns = [
    ...
    columnHelper.accessor("pollsCreated", {
      header: "Total Polls Created",
      size: 80,
    }),

    columnHelper.accessor("freePollsCreated", {
      header: "FreePolls",
      size: 40,
    }),
    columnHelper.accessor("paidPollsCreated", {
      header: "PaidPolls",
      size: 40,
    }),
    columnHelper.accessor("revenueToAdminCurrent", {
      header: "TotalRevenueAdmin",
      size: 50,
    }),
