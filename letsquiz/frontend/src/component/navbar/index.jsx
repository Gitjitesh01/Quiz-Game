...
import navbarimage from "../../assets/img/Lets Quiz Black.png";
...
const Navbar = (props) => {
  ...
  return (
    <nav className="sticky top-[0.1px] z-40 flex flex-row flex-wrap items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0b14374d]">
