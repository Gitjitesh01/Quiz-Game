...
function MobilePreview({className, name, showForm, formContent, children}: MobilePreviewInterface) {
  ...
  return (
    <div className={`flex flex-col m-1 relative rounded bg-transparent bg-top bg-cover p-5 max-w-[256px] h-full w-64 min-w-[256px] overflow-x-hidden ${className}`} style={{backgroundImage: `url('/iphone.png')`}}>
