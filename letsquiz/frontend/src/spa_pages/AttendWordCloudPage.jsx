...
import CircularIndeterminate from "../component/AttendQuizComponents/Loading.jsx";
import AttendForm from "../component/AttendQuizComponents/AttendForm.jsx";
// import AttendForm from "../../component/AttendQuizcomponent/AttendForm";
...
export default function AttendWordCloudPage() {
    ...
    if (localId) {
      const getUser = async () => {
        try {
          ...
          responseData.userid = userData._id;
          responseData.quizAttend.firstName = userData.firstname;
          responseData.quizAttend.lastName = userData.lastname;
          responseData.quizAttend.userid = [userData._id];
  ...
  const fetchQuizData = async () => {
    try {
      ...
      responseData.quizAttend.quizid = resData._id;
