  ...
  const questionType = {
                ...
                <div className="my-2 flex">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      // Directly prevent updates if the length exceeds the limit
                      if (newValue.length > 50) {
                        swal(
                          "Error",
                          "Option cannot be more than 50 characters",
                          "error"
                        );
                        return;
                      }
                      ...
                      let temp = [...props.questions];
                      temp[props.index].options[index].text = newValue;
                      props.setQuestions(temp);
                    }}
                    required
                  />
                  ...
                  <input
                    ...
                    required
                    value={
                      props.questions[props.index].options[index].selection
                    }
                    onChange={(e) => {
                      const newValue = e.target.value;
                      ...
                      let temp = [...props.questions];
                      temp[props.index].options[index].selection =
                        e.target.value;
                      props.setQuestions(temp);
                    }}
                  />
    ...
    date: (
      <>
        <input
          type="date"
          value={props.questions[props.index].answer_options[0].text}
          onChange={(e) => {
            let temp = [...props.questions];
            temp[props.index].answer_options[0].text = e.target.value;
            props.setQuestions(temp);
          }}
          className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
