...
function TopCreatorTable(props) {
  ...
  return (
    <Card extra={"h-[600px] w-full"}>
      {/* Top Creator Header */}
      <div className="dark:!bg-navy-700 flex h-fit w-full items-center justify-between rounded-t-2xl bg-white px-4 pb-[20px] pt-4 shadow-2xl shadow-gray-100 dark:shadow-none">
